          ...
          <div className="grid gap-12 lg:grid-cols-2">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {businessArms.map((arm, index) => (
                <div
                  key={index}
                  className="rounded-lg border border-slate-700 bg-slate-950/50 p-5"
                >
                  ...
                  <h3 className="mt-4 font-semibold text-slate-100">{arm.title}</h3>
                  <p className="mt-2 text-sm text-slate-400">{arm.description}</p>
                </div>
              ))}
            </div>
          </div>
